...
const Barr =(props:any) => {
  ...
  return (
    <div className="flex flex-col h-screen w-[22%] bg-gray-100 p-4 gap-9 border-r-2 border-gray-300">
        ...
        <div>
              <div>
                <h1 className="font-semibold text-l text-black" >Others</h1>
              </div>
              <div className="ml-3 mt-4 flex flex-col  gap-3">
                <li className="list-none flex items-center"><GoArchive className="mr-2"/><h2>Archive</h2></li>
              </div>
        </div>
        <div>
              <div>
                <h1 className="font-semibold text-l text-black" >My Team</h1>
              </div>
              <div className="ml-3 mt-4 flex flex-col  gap-3">
               <li className="list-none flex items-center"><GoPeople className="mr-2"/><h2>My workspace</h2></li>
               <li className="list-none flex items-center"><GoPeople className="mr-2"/><h2>My home</h2></li>
              </div>
        </div>
    </div>
  )
